...
int main(int argc, char **argv)
{
  ...
  tf2_ros:: new Buffer tfBuffer;
  tf2_ros:: new TransformListener tfListener(*tfBuffer);
  ...
  globalPlanner.initialize("base_global_planner", global_costmap->getCostmap(), "map");
